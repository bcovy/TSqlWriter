...
namespace SqlWriter;
/// <summary>
/// Builds a SQL query statement from 4 tables.  Inherits <see cref="ISqlStatement"/>.
/// </summary>
...
/// <typeparam name="T5">Entity table type.</typeparam>
public interface IQuery<T, T2, T3, T4, T5> : ISqlStatement where T : class where T2 : class where T3 : class where T4 : class where T5 : class
{
    /// <summary>
    ...
    /// <example>
    /// <code>(a, b, c, d, e) => new { a.ID, Address = b.Address1, c.City, d.Status, Alias1 = "hello world" } //will project to: SELECT a.ID, b.Address1 AS [Address], c.City, d.Status, @p0 AS [Alias1]</code>
    /// </example>
    /// </summary>
    /// <remarks>
    /// Method will parameterize an input values in the statement, and create an associated input parameter.
    /// </remarks>
    /// <param name="columns"><see cref="NewExpression"/> anonymous object of column names.</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4, T5> Select(Expression<Func<T, T2, T3, T4, T5, object>> columns);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4, T5> Select(params string[] columns);
    /// <summary>
    /// Uses the <typeparamref name="TProjection"/> type to project the columns that will appear in the SELECT statement.   
    /// </summary>
    /// <remarks>
    /// Builder will search <typeparamref name="T"/>, <typeparamref name="T2"/>, <typeparamref name="T3"/>, <typeparamref name="T4"/> and <typeparamref name="T5"/> entities 
    /// in the order it was applied during the instantiation period, and attach the associated table alias to the first match that is found.  
    /// Once a match is found, the column is removed from any further searches on additional entities.  This is done to eliminate duplicate 
    /// column names in the final condition.  
    /// </remarks>
    /// <typeparam name="TProjection">Projection model type.</typeparam>
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4, T5> Select<TProjection>() where TProjection : class;
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4, T5> SelectRaw(string statement, string aliasName);
    IQuery<T, T2, T3, T4, T5> SelectTop(int topValue);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4, T5> SelectSubquery(string columnName, Func<ISubquery> subquery);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4, T5> Join<TTable1, TTable2>(JoinType joinType = JoinType.Inner) where TTable1 : class where TTable2 : class;
    /// <summary>
    ...
    /// </remarks>
    IQuery<T, T2, T3, T4, T5> Join(Action<IJoinMapper> mapper);
    /// <summary>
    /// Create a single join condition between two table entities. 
    /// </summary>
    /// <param name="columns">Expects a <see cref="BinaryExpression"/> that represents a SQL column join condition.  
    /// Allows up to two conditions.</param>
    /// <param name="joinType">SQL join type.</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain query methods.</returns>
    /// <remarks>
    /// Use the associated expression parameter methods to identify the target tables to join.
    /// </remarks>
    IQuery<T, T2, T3, T4, T5> Join(Expression<Func<T, T2, T3, T4, T5, bool>> columns, JoinType joinType);
    /// <summary>
    ...
    /// or <typeparamref name="T5"/> represents the entity table for which the CTE statement will use as the parent join
    /// target.  This method assumes <typeparamref name="T"/>, <typeparamref name="T2"/>, <typeparamref name="T3"/>,
    /// <typeparamref name="T4"/>, or <typeparamref name="T5"/>, and CTE statement share the same column name used in
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4, T5> With<TProperty>(Expression<Func<T, T2, T3, T4, T5, TProperty>> joinColumnName, ICteStatement cteStatement);
    /// <summary>
    /// Joins a common table expression (CTE) to the current query statement as an Inner Join.
    /// </summary>
    /// <remarks>
    /// <typeparamref name="T"/>, <typeparamref name="T2"/>, <typeparamref name="T3"/>, <typeparamref name="T4"/>, or <typeparamref name="T5"/> 
    /// represent the entity table for which the CTE statement will use as the Parent/Right join target.  <typeparamref name="TCteJoinTable"/> 
    /// represents the entity used to form the column(s) that make up the Right side of the join.
    /// </remarks>
    ...
    /// <param name="cteStatement">CTE statement.</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4, T5> With<TCteJoinTable>(Expression<Func<T, T2, T3, T4, T5, TCteJoinTable, bool>> joinExpression, ICteStatement cteStatement) where TCteJoinTable : class;
    /// <summary>
    ...
    /// <param name="cteStatement">CTE statement.</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4, T5> WithLeft<TProperty>(Expression<Func<T, T2, T3, T4, T5, TProperty>> joinColumnName, ICteStatement cteStatement);
    /// <summary>
    /// Joins a common table expression (CTE) to the current query statement as a Left Outer Join.
    /// </summary>
    /// <remarks>
    ...
    /// <param name="cteStatement">CTE statement.</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4, T5> WithLeft<TCteJoinTable>(Expression<Func<T, T2, T3, T4, T5, TCteJoinTable, bool>> joinExpression, ICteStatement cteStatement) where TCteJoinTable : class;
    /// <summary>
    /// Expects a <see cref="BinaryExpression"/> expression consisting of one or multiple WHERE conditions. Basic example:
    /// <example><code>(a, b, c, d, e) => a.ID == 1 (and) b.Address == "Westminster"</code></example> 
    /// <see cref="Conditions"/> methods can also be used: 
    /// <example><code>(a, b, c, d, e) => Conditions.In(a.PropertyID, 1, 2, 3)</code></example>
    /// </summary>
    /// <remarks>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4, T5> WhereExists<TExists, TOuter>(Expression<Func<TExists, TOuter, bool>> expression) where TExists : class where TOuter : class;
    /// <summary>
    ...
    /// <param name="expression">Expression that defines how the subquery matches rows to the outer query.  Can also include additional filter criteria.</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4, T5> WhereNotExists<TExists, TOuter>(Expression<Func<TExists, TOuter, bool>> expression) where TExists : class where TOuter : class;
    /// <summary>
    ...
    /// <param name="subquery">Func delegate.  Must return an <see cref="ISubquery"/> object</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4, T5> WhereSubquery<TColumn>(Expression<Func<T, T2, T3, T4, T5, TColumn>> expression, Func<ISubquery> subquery);
    /// <summary>
    /// Apply subquery to WHERE condition for the target column used in the <paramref name="expression"/> parameter.
    /// </summary>
    /// <remarks>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4, T5> WhereSubquery<TColumn>(Expression<Func<T, T2, T3, T4, T5, TColumn>> expression, ISubquery subquery);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2, T3, T4, T5> GroupBy<TProperty>(Expression<Func<T, T2, T3, T4, T5, TProperty>> column);
    /// <summary>
    ...
    /// <param name="column">Column.</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2, T3, T4, T5> GroupBy(Expression<Func<T, T2, T3, T4, T5, object>> column);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2, T3, T4, T5> OrderBy(string column, string direction);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2, T3, T4, T5> OrderByAsc<TProperty>(Expression<Func<T, T2, T3, T4, T5, TProperty>> column);
    /// <summary>
    /// Sorts data returned by the query in ascending order.
    /// </summary>
    /// <param name="column">Sort column.</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2, T3, T4, T5> OrderByAsc(string column);
    /// <summary>
    ...
    /// <typeparam name="TProperty">Column type.</typeparam>
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2, T3, T4, T5> OrderByDesc<TProperty>(Expression<Func<T, T2, T3, T4, T5, TProperty>> column);
    /// <summary>
    /// Sorts data returned by the query in descending order.
    /// </summary>
    /// <param name="column">Sort column.</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2, T3, T4, T5> OrderByDesc(string column);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4, T5}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4, T5> Pager(int pageIndex, int pageSize);
}
