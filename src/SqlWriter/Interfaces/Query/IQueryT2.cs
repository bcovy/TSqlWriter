...
/// <summary>
/// Builds a SQL query statement from 2 tables.  Inherits <see cref="ISqlStatement"/>.
/// </summary>
/// <typeparam name="T">Entity table type.</typeparam>
/// <typeparam name="T2">Entity table type.</typeparam>
public interface IQuery<T, T2> : ISqlStatement where T : class where T2 : class
{
    /// <summary>
    ...
    /// <example>
    /// <code>(a, b) => new { a.ID, Address = b.Address1, Alias1 = "hello world" } //will project to: SELECT a.ID, b.Address1 AS [Address], @p0 AS [Alias1]</code>
    /// </example>
    /// </summary>
    /// <remarks>
    ...
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2> Select(Expression<Func<T, T2, object>> columns);
    /// <summary>
    /// Adds column name(s) as raw un-parameterized string value.  If column includes an alias name, item should be
    /// added as a single string value: 
    ...
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2> Select(params string[] columns);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2> Select<TProjection>() where TProjection : class;
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2> SelectRaw(string statement, string aliasName);
    IQuery<T, T2> SelectTop(int topValue);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2> SelectSubquery(string columnName, Func<ISubquery> subquery);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2> Join<TTable1, TTable2>(JoinType joinType = JoinType.Inner) where TTable1 : class where TTable2 : class;
    /// <summary>
    ...
    /// <param name="joinType">Join type.</param>
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2> Join(Expression<Func<T, T2, bool>> columns, JoinType joinType);
    /// <summary>
    ...
    /// or two key pair(s).</param>
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2> JoinInner(Expression<Func<T, T2, bool>> columns);
    /// <summary>
    ...
    /// or two key pair(s).</param>
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2> JoinLeftOuter(Expression<Func<T, T2, bool>> columns);
    /// <summary>
    /// Joins a common table expression (CTE) to the current query statement as an Inner Join.
    /// </summary>
    /// <remarks>
    /// <typeparamref name="T"/> or <typeparamref name="T2"/> represents the entity table for which the CTE statement
    /// will use as the parent join target.  This method assumes <typeparamref name="T"/> or <typeparamref name="T2"/>,
    ...
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2> With<TProperty>(Expression<Func<T, T2, TProperty>> joinColumnName, ICteStatement cteStatement);
    /// <summary>
    /// Joins a common table expression (CTE) to the current query statement as an Inner Join.
    /// </summary>
    /// <remarks>
    /// <typeparamref name="T"/> or <typeparamref name="T2"/> represent the entity table for which the CTE statement will use as the Parent/Right join target.
    ...
    /// <param name="cteStatement">CTE statement.</param>
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2> With<TCteJoinTable>(Expression<Func<T, T2, TCteJoinTable, bool>> joinExpression, ICteStatement cteStatement) where TCteJoinTable : class;
    /// <summary>
    ...
    /// <param name="cteStatement">CTE statement.</param>
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2> WithLeft<TProperty>(Expression<Func<T, T2, TProperty>> joinColumnName, ICteStatement cteStatement);
    /// <summary>
    /// Joins a common table expression (CTE) to the current query statement as a Left Outer Join.
    /// </summary>
    /// <remarks>
    ...
    /// <param name="cteStatement">CTE statement.</param>
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2> WithLeft<TCteJoinTable>(Expression<Func<T, T2, TCteJoinTable, bool>> joinExpression, ICteStatement cteStatement) where TCteJoinTable : class;
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2> WhereExists<TExists, TOuter>(Expression<Func<TExists, TOuter, bool>> expression) where TExists : class where TOuter : class;
    /// <summary>
    ...
    /// <param name="expression">Expression that defines how the subquery matches rows to the outer query.  Can also include additional filter criteria.</param>
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2> WhereNotExists<TExists, TOuter>(Expression<Func<TExists, TOuter, bool>> expression) where TExists : class where TOuter : class;
    /// <summary>
    ...
    /// <param name="subquery">Func delegate.  Must return an <see cref="ISubquery"/> object</param>
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2> WhereSubquery<TColumn>(Expression<Func<T, T2, TColumn>> expression, Func<ISubquery> subquery);
    /// <summary>
    /// Apply subquery to WHERE condition for the target column used in the <paramref name="expression"/> parameter.
    /// </summary>
    /// <remarks>
    ...
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2> WhereSubquery<TColumn>(Expression<Func<T, T2, TColumn>> expression, ISubquery subquery);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2> GroupBy<TProperty>(Expression<Func<T, T2, TProperty>> column);
    /// <summary>
    ...
    /// <param name="column">Column.</param>
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2> GroupBy(Expression<Func<T, T2, object>> column);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2> OrderBy(string column, string direction);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2> OrderByAsc<TProperty>(Expression<Func<T, T2, TProperty>> column);
    /// <summary>
    /// Sorts data returned by the query in ascending order.
    /// </summary>
    /// <param name="column">Sort column.</param>
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2> OrderByAsc(string column);
    /// <summary>
    ...
    /// <typeparam name="TProperty">Column type.</typeparam>
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2> OrderByDesc<TProperty>(Expression<Func<T, T2, TProperty>> column);
    /// <summary>
    /// Sorts data returned by the query in descending order.
    /// </summary>
    /// <param name="column">Sort column.</param>
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2> OrderByDesc(string column);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2> Pager(int pageIndex, int pageSize);
}