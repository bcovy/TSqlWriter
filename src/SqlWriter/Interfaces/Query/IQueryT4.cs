...
public interface IQuery<T, T2, T3, T4> : ISqlStatement where T : class where T2 : class where T3 : class where T4 : class
{
    /// <summary>
    ...
    /// <example>
    /// <code>(a, b, c, d) => new { a.ID, Address = b.Address1, c.City, d.Status, Alias1 = "hello world" } //will project to: SELECT a.ID, b.Address1 AS [Address], c.City, d.Status, @p0 AS [Alias1]</code>
    /// </example>
    /// </summary>
    /// <remarks>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4> Select(Expression<Func<T, T2, T3, T4, object>> columns);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4> Select(params string[] columns);
    /// <summary>
    /// Uses the <typeparamref name="TProjection"/> type to project the columns that will appear in the SELECT statement.   
    /// </summary>
    /// <remarks>
    /// Builder will search <typeparamref name="T"/>, <typeparamref name="T2"/>, <typeparamref name="T3"/> and <typeparamref name="T4"/> entities 
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4> Select<TProjection>() where TProjection : class;
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4> SelectRaw(string statement, string aliasName);
    IQuery<T, T2, T3, T4> SelectTop(int topValue);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4> SelectSubquery(string columnName, Func<ISubquery> subquery);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4> Join<TTable1, TTable2>(JoinType joinType = JoinType.Inner) where TTable1 : class where TTable2 : class;
    /// <summary>
    ...
    /// </remarks>
    IQuery<T, T2, T3, T4> Join(Action<IJoinMapper> mapper);
    /// <summary>
    ...
    /// </remarks>
    IQuery<T, T2, T3, T4> Join(Expression<Func<T, T2, T3, T4, bool>> columns, JoinType joinType);
    /// <summary>
    /// Joins a common table expression (CTE) to the current query statement as an Inner Join.
    /// </summary>
    /// <remarks>
    /// <typeparamref name="T"/>, <typeparamref name="T2"/>, <typeparamref name="T3"/>, or <typeparamref name="T4"/>
    /// represents the entity table for which the CTE statement will use as the parent join target.  This method
    /// assumes <typeparamref name="T"/>, <typeparamref name="T2"/>, <typeparamref name="T3"/>, or <typeparamref name="T4"/>,
    /// and CTE statement share the same column name used in the <paramref name="joinColumnName"/> member expression.
    /// </remarks>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4> With<TProperty>(Expression<Func<T, T2, T3, T4, TProperty>> joinColumnName, ICteStatement cteStatement);
    /// <summary>
    /// Joins a common table expression (CTE) to the current query statement as an Inner Join.
    /// </summary>
    /// <remarks>
    /// <typeparamref name="T"/>, <typeparamref name="T2"/>, <typeparamref name="T3"/>, or <typeparamref name="T4"/> represent the entity table for which the CTE 
    ...
    /// <param name="cteStatement">CTE statement.</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4> With<TCteJoinTable>(Expression<Func<T, T2, T3, T4, TCteJoinTable, bool>> joinExpression, ICteStatement cteStatement) where TCteJoinTable : class;
    /// <summary>
    ...
    /// <param name="cteStatement">CTE statement.</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4> WithLeft<TProperty>(Expression<Func<T, T2, T3, T4, TProperty>> joinColumnName, ICteStatement cteStatement);
    /// <summary>
    /// Joins a common table expression (CTE) to the current query statement as a Left Outer Join.
    /// </summary>
    /// <remarks>
    ...
    /// <param name="cteStatement">CTE statement.</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4> WithLeft<TCteJoinTable>(Expression<Func<T, T2, T3, T4, TCteJoinTable, bool>> joinExpression, ICteStatement cteStatement) where TCteJoinTable : class;
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4> WhereExists<TExists, TOuter>(Expression<Func<TExists, TOuter, bool>> expression) where TExists : class where TOuter : class;
    /// <summary>
    ...
    /// <param name="expression">Expression that defines how the subquery matches rows to the outer query.  Can also include additional filter criteria.</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4> WhereNotExists<TExists, TOuter>(Expression<Func<TExists, TOuter, bool>> expression) where TExists : class where TOuter : class;
    /// <summary>
    ...
    /// <param name="subquery">Func delegate.  Must return an <see cref="ISubquery"/> object</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4> WhereSubquery<TColumn>(Expression<Func<T, T2, T3, T4, TColumn>> expression, Func<ISubquery> subquery);
    /// <summary>
    /// Apply subquery to WHERE condition for the target column used in the <paramref name="expression"/> parameter.
    /// </summary>
    /// <remarks>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4> WhereSubquery<TColumn>(Expression<Func<T, T2, T3, T4, TColumn>> expression, ISubquery subquery);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2, T3, T4> GroupBy<TProperty>(Expression<Func<T, T2, T3, T4, TProperty>> column);
    /// <summary>
    ...
    /// <param name="column">Column.</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2, T3, T4> GroupBy(Expression<Func<T, T2, T3, T4, object>> column);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2, T3, T4> OrderBy(string column, string direction);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2, T3, T4> OrderByAsc<TProperty>(Expression<Func<T, T2, T3, T4, TProperty>> column);
    /// <summary>
    /// Sorts data returned by the query in ascending order.
    /// </summary>
    /// <param name="column">Sort column.</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2, T3, T4> OrderByAsc(string column);
    /// <summary>
    ...
    /// <typeparam name="TProperty">Column type.</typeparam>
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2, T3, T4> OrderByDesc<TProperty>(Expression<Func<T, T2, T3, T4, TProperty>> column);
    /// <summary>
    /// Sorts data returned by the query in descending order.
    /// </summary>
    /// <param name="column">Sort column.</param>
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain statement methods.</returns>
    IQuery<T, T2, T3, T4> OrderByDesc(string column);
    /// <summary>
    ...
    /// <returns><see cref="IQuery{T, T2, T3, T4}"/> object to allow user to chain query methods.</returns>
    IQuery<T, T2, T3, T4> Pager(int pageIndex, int pageSize);
}